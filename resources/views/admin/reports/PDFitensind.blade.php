...
<head>
    <meta charset="utf-8">
    <title>Relatório de Equipamentos Indisponíveis</title>
    <style>
...
<body>
    <h1>Relatório de Equipamentos Indisponíveis (Ocultos)</h1>
    ...
    <p style="margin-top: 15px;"><strong>Total de unidades indisponíveis:</strong> {{ $unidades->count() }}</p>
    @else
    <p class="vazio">Não existem equipamentos indisponíveis de momento.</p>
    @endif
</body>
</html>
    ...
    'menu' => [
        ...
        [
            ...
            'submenu' => [
                ...
                [
                    ...
                    'url'  => '/admin/reserves/pending'
                ],
                [
                    'text' => 'Reservas em Atraso',
                    'url'  => '/admin/reserves/delayed',
                ],
                [
                    'text' => 'Reservas em Curso',
                    'url'  => '/admin/reserves/ongoing',
                ],
                [
                    'text' => 'Reservas não Autorizadas',
                    'url'  => '/admin/reserves/unauthorized',
                ],
                [
                    'text' => 'Reservas Finalizadas',
                    'url'  => '/admin/reserves/completed',
                ],
            ],
        ],
        [
        ...
        [
            ...
            'submenu' => [
                ...
                [
                    'text' => 'Criar Horário',
                    'url'  => '/admin/disponibilidade/create'
                ],
            ],
        ],
        [
